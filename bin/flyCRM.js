...
Application.init = $hx_exports.initApp = function(config) {
	...
	while(_g < fields.length) {
		var f = fields[_g];
		++_g;
		if(Reflect.field(config,f) != null) Reflect.setField(Application,f,Reflect.field(config,f));
	...
	,initUI: function(viewConfigs) {
		...
		while(_g < viewConfigs.length) {
			...
			if(cl != null) {
				...
				haxe.Log.trace("views.set(" + Std.string(iParam.id) + ")",{ fileName : "Application.hx", lineNumber : 70, className : "Application", methodName : "initUI"});
			}
		}
	}
	,test: function() {
		...
		var t = "hello";
		haxe.Log.trace(t + ":" + t.indexOf("lo"),{ fileName : "Application.hx", lineNumber : 85, className : "Application", methodName : "test"});
		var ctempl = new EReg("{([a-x]*)}","g").map(template,function(r) {
			var m = r.matched(1);
			var d = Std.string(Reflect.field(data,m));
			if(d.indexOf("{") == 0) haxe.Log.trace("nested template :) " + d.indexOf("{"),{ fileName : "Application.hx", lineNumber : 92, className : "Application", methodName : "test"});
			return d;
		});
		haxe.Log.trace(ctempl,{ fileName : "Application.hx", lineNumber : 95, className : "Application", methodName : "test"});
	}
...
var View = function(data) {
	...
	haxe.Log.trace(this.name + ":" + this.id + ":" + this.root.length + ":" + Std.string(this.attach2),{ fileName : "View.hx", lineNumber : 48, className : "View", methodName : "new"});
};
$hxClasses["View"] = View;
View.__name__ = ["View"];
View.prototype = {
	...
	,addView: function(v) {
		...
		if(cl != null) {
			...
			haxe.Log.trace(Std.string(iParam),{ fileName : "View.hx", lineNumber : 63, className : "View", methodName : "addView"});
			av = Type.createInstance(cl,[iParam]);
			this.views.set(iParam.id,av);
			haxe.Log.trace("views.set(" + Std.string(iParam.id) + ")",{ fileName : "View.hx", lineNumber : 66, className : "View", methodName : "addView"});
		}
		return av;
	}
	,loadData: function(url,params,callBack,parent) {
		haxe.Log.trace(Std.string(params),{ fileName : "View.hx", lineNumber : 74, className : "View", methodName : "loadData"});
		haxe.Log.trace(url,{ fileName : "View.hx", lineNumber : 76, className : "View", methodName : "loadData"});
		$.post(url,params,function(data,textStatus,xhr) {
			callBack(data,parent);
		});
	}
	,update: function(data,parent) {
		haxe.Log.trace("has to be implemented in subclass!",{ fileName : "View.hx", lineNumber : 87, className : "View", methodName : "update"});
	}
	,__class__: View
};
var haxe = {};
...
view.Clients = function(data) {
	...
	haxe.Log.trace("#t-" + this.id + " attach2:" + data.attach2,{ fileName : "Clients.hx", lineNumber : 35, className : "view.Clients", methodName : "new"});
	haxe.Log.trace(new $("#t-" + this.id),{ fileName : "Clients.hx", lineNumber : 37, className : "view.Clients", methodName : "new"});
	haxe.Log.trace(new $("#t-" + this.id).tmpl(data),{ fileName : "Clients.hx", lineNumber : 38, className : "view.Clients", methodName : "new"});
...
view.Clients.prototype = $extend(View.prototype,{
	...
	,resetParams: function() {
		...
		this.params = { action : "find", className : this.name, dataType : "json", fields : this.fields.join(","), limit : this.vData.limit, table : this.vData.table, where : this.vData.where};
		return this.params;
	}
	,order: function(field) {
		haxe.Log.trace(field,{ fileName : "Clients.hx", lineNumber : 66, className : "view.Clients", methodName : "order"});
	...
	,update: function(data,parentSelector) {
		...
		haxe.Log.trace("parent:" + parentSelector + ":" + Std.string(new $(parentSelector).first()),{ fileName : "Clients.hx", lineNumber : 78, className : "view.Clients", methodName : "update"});
...
view.ContextMenu = function(data) {
	...
	this.root = js.JqueryUI.accordion(new $("#" + this.id),{ active : 0});
...
view.ContextMenu.prototype = $extend(View.prototype,{
	...
	,run: function(evt) {
		...
		haxe.Log.trace(((function($this) {
			...
			$r = new $(html);
			return $r;
		}(this))).parent().get()[0].nodeName,{ fileName : "ContextMenu.hx", lineNumber : 49, className : "view.ContextMenu", methodName : "run"});
		var formData = ((function($this) {
			var $r;
			var html1;
		...
		this.loadData("server.php","className=" + Std.string(this.vData.className) + "&" + formData,$bind(this,this.showResult));
	}
	,showResult: function(data,_) {
		haxe.Log.trace(data,{ fileName : "ContextMenu.hx", lineNumber : 56, className : "view.ContextMenu", methodName : "showResult"});
	}
