...
App.inputError = function(form,inputs) {
	haxe_Log.trace(form.attr("id") + ":" + Std.string(inputs),{ fileName : "App.hx", lineNumber : 79, className : "App", methodName : "inputError"});
...
App.choice = $hx_exports["choice"] = function(data) {
	if(data != null && data.id != null) {
		...
		haxe_Log.trace(Std.string(data.id) + ":" + $("#" + Std.string(data.id) + " .overlay .scrollbox").length + ":" + $("#" + Std.string(data.id) + " .overlay").height(),{ fileName : "App.hx", lineNumber : 97, className : "App", methodName : "choice"});
...
App.modal = $hx_exports["modal"] = function(mID,data) {
	haxe_Log.trace(data,{ fileName : "App.hx", lineNumber : 107, className : "App", methodName : "modal"});
	if(data != null && data.mID != null) {
		...
		haxe_Log.trace(Std.string(data.id) + ":" + $("#" + Std.string(data.id) + " .overlay .scrollbox").length + ":" + $("#" + Std.string(data.id) + " .overlay").height(),{ fileName : "App.hx", lineNumber : 111, className : "App", methodName : "modal"});
		$("#" + Std.string(data.id) + " .overlay .scrollbox").height($("#" + Std.string(data.id) + " .overlay").height());
	} else {
...
App.info = $hx_exports["info"] = function(data) {
	haxe_Log.trace(data,{ fileName : "App.hx", lineNumber : 121, className : "App", methodName : "info"});
	if(data.target == null && data.id != null) {
		...
		haxe_Log.trace(Std.string(data.id) + ":" + $("#" + Std.string(data.id) + " .overlay .scrollbox").length + ":" + $("#" + Std.string(data.id) + " .overlay").height(),{ fileName : "App.hx", lineNumber : 126, className : "App", methodName : "info"});
	} else {
...
App.prototype = {
	...
	,logTrace: function(logMsg,file) {
		...
		haxe_Log.trace(logMsg,{ fileName : "App.hx", lineNumber : 134, className : "App", methodName : "logTrace"});
		var p = { logFile : "/var/log/flyCRM/app.log", user : App.user, log : logMsg};
		$.post("/flyCRM/formLog2.php",p).done(function() {
			haxe_Log.trace("log success",{ fileName : "App.hx", lineNumber : 141, className : "App", methodName : "logTrace"});
		}).fail(function() {
			haxe_Log.trace("error",{ fileName : "App.hx", lineNumber : 144, className : "App", methodName : "logTrace"});
		});
	}
	,initUI: function(viewConfigs) {
		...
		while(_g < viewConfigs.length) {
			...
			if(cl != null) {
				...
				haxe_Log.trace("views.set(" + av.instancePath + ")",{ fileName : "App.hx", lineNumber : 192, className : "App", methodName : "initUI"});
			}
		}
	...
	,test: function() {
		...
		var t = "hello";
		haxe_Log.trace(t + ":" + t.indexOf("lo"),{ fileName : "App.hx", lineNumber : 264, className : "App", methodName : "test"});
		var ctempl = new EReg("{([a-x]*)}","g").map(template,function(r) {
			var m = r.matched(1);
			var d = Std.string(Reflect.field(data,m));
			if(d.indexOf("{") == 0) {
				haxe_Log.trace("nested template :) " + d.indexOf("{"),{ fileName : "App.hx", lineNumber : 271, className : "App", methodName : "test"});
			}
			return d;
		});
		haxe_Log.trace(ctempl,{ fileName : "App.hx", lineNumber : 274, className : "App", methodName : "test"});
	}
	,__class__: App
};
...
View.prototype = {
	...
	,loadAllData: function(loaderIndex) {
		...
		while(k.hasNext()) {
			var k1 = k.next();
			haxe_Log.trace(k1,{ fileName : "View.hx", lineNumber : 299, className : "View", methodName : "loadAllData"});
	...
	,load: function(loaderId,loaderIndex) {
		...
		if(!loader.valid) {
			this.loadData("server.php",loader.prepare(),function(data) {
				...
				haxe_Log.trace(_gthis.id + ":" + Std.string(data.fields) + ":" + Std.string(data.loaderId),{ fileName : "View.hx", lineNumber : 313, className : "View", methodName : "load"});
	...
	,update: function(data) {
		...
		haxe_Log.trace(Std.string($("#" + this.id + "-menu").offset().left - 35) + " reloadID:" + this.reloadID,{ fileName : "View.hx", lineNumber : 450, className : "View", methodName : "update"});
		this.wait(false);
		if(this.reloadID != null) {
			haxe_Log.trace("#" + this.reloadID + " : " + $("#" + this.reloadID).length,{ fileName : "View.hx", lineNumber : 454, className : "View", methodName : "update"});
			$("#" + this.reloadID).children().first().trigger("click");
			haxe_Log.trace(this.id + ":" + $("#" + this.id + "-list tr[class~=\"selected\"]").length,{ fileName : "View.hx", lineNumber : 456, className : "View", methodName : "update"});
			this.reloadID = null;
		}
	}
	,runLoaders: function() {
		haxe_Log.trace(this.dbLoaderIndex,{ fileName : "View.hx", lineNumber : 464, className : "View", methodName : "runLoaders"});
		this.loadAllData(this.dbLoaderIndex);
	}
	,select: function(evt) {
		haxe_Log.trace("has to be implemented in subclass!",{ fileName : "View.hx", lineNumber : 470, className : "View", methodName : "select"});
	}
	,wait: function(start,message,timeout) {
		...
		if(!start && this.waiting != null) {
			...
			$("#wait").animate({ opacity : 0.0},300,null,function() {
				$("#wait").detach();
				haxe_Log.trace($("#wait").length,{ fileName : "View.hx", lineNumber : 479, className : "View", methodName : "wait"});
			});
			this.spinner.stop();
		}
		if(!start) {
		...
		if(message == App.uiMessage.retry || message == App.uiMessage.timeout) {
			...
			haxe_Log.trace("set timeout:" + timeout + ":" + message,{ fileName : "View.hx", lineNumber : 500, className : "View", methodName : "wait"});
			this.waiting = haxe_Timer.delay(function() {
...
js_JqueryUI.datepicker = function(dp,options) {
	var tmp = dp.datepicker(options);
	var tmp1 = DateTools.format(new Date(),"%d.%m.%Y");
	return tmp.attr("placeholder",tmp1);
};
...
var js_jQuery_JHelper = function() { };
$hxClasses["js.jQuery.JHelper"] = js_jQuery_JHelper;
js_jQuery_JHelper.__name__ = ["js","jQuery","JHelper"];
js_jQuery_JHelper.J = function(html) {
	return $(html);
};
js_jQuery_JHelper.vsprintf = function(format,args) {
...
view_Editor.prototype = $extend(View.prototype,{
	...
	,compareEdit: function(data) {
		...
		while(_g < _g1.length) {
			...
			if(!cOK) {
				haxe_Log.trace("" + Std.string(dbData) + "< oops - " + f + ": >" + shouldDVal + "< not = >" + this.overlay.find("[name=\"" + f + "\"]").val() + "<",{ fileName : "Editor.hx", lineNumber : 168, className : "view.Editor", methodName : "compareEdit"});
				errors_b += Std.string("oops - " + f + ": " + shouldDVal + " not = " + this.overlay.find("[name=\"" + f + "\"]").val() + "<-\r\n");
			}
		}
	...
	,edit: function(dataRow) {
		...
		haxe_Log.trace(p,{ fileName : "Editor.hx", lineNumber : 228, className : "view.Editor", methodName : "edit"});
	...
	,update: function(data) {
		...
		$("#" + this.parentView.id + "-edit-form .datepicker").each(function(i,n) {
			...
			if(dateString != null && dateString != 0 && dateString != "" && dateString != "0000-00-00") {
				js_JqueryUI.datepicker($(n),{ dateFormat : "dd.mm.yy"}).val(DateTools.format(HxOverrides.strDate(dateString),"%d.%m.%Y"));
			} else {
				js_JqueryUI.datepicker($(n),{ dateFormat : "dd.mm.yy"}).attr("placeholder",DateTools.format(new Date(),"%d.%m.%Y"));
			}
		});
		$("#" + this.parentView.id + " .scrollbox").height($("#" + this.parentView.id + " #overlay").height());
...
view_ClientHistory.prototype = $extend(View.prototype,{
	...
	,select: function(evt) {
		...
		if(App.ist.ctrlPressed) {
			haxe_Log.trace("ctrlPressed",{ fileName : "ClientHistory.hx", lineNumber : 60, className : "view.ClientHistory", methodName : "select"});
		}
...
var view_ContextMenu = function(data) {
	...
	this.root = $("#" + this.id).accordion({ active : 0, activate : $bind(this,this.activate), "autoHeight" : false, beforeActivate : function(event,ui) {
		if(_gthis.root.data("disabled")) {
			...
			var tmp1 = $(ui.newPanel[0]);
			_gthis.activePanel = tmp1;
		}
	...
	,call: function(editor,onComplete) {
		...
		this.parentView.loadData("server.php",p,function(data) {
			...
			if(data.response == "OK") {
				...
				haxe_Log.trace(_gthis.activePanel.find("button[data-contextaction=\"call\"]").length,{ fileName : "ContextMenu.hx", lineNumber : 156, className : "view.ContextMenu", methodName : "call"});
...
view_FormData.filter = function(jForm,tableData,tableNames) {
	...
	while(_g < tableNames.length) {
		...
		while(_g1 < tD.length) {
			...
			if(!(v != null && v != 0 && v != "")) {
				haxe_Log.trace("" + tDn + " not set:" + jForm.find("[name=\"" + tDn + "\"]").val(),{ fileName : "FormData.hx", lineNumber : 150, className : "view.FormData", methodName : "filter"});
				continue;
			}
			...
			if(matchTypeOption.length == 1) {
				...
				switch(_g2) {
				case "any":
					tmp = tDn + "|LIKE|%" + jForm.find("[name=\"" + tDn + "\"]").val() + "%";
					break;
				case "end":
					tmp = tDn + "|LIKE|%" + jForm.find("[name=\"" + tDn + "\"]").val();
					break;
				case "exact":
					tmp = tDn + "|" + jForm.find("[name=\"" + tDn + "\"]").val();
					break;
				case "start":
					tmp = tDn + "|LIKE|" + jForm.find("[name=\"" + tDn + "\"]").val() + "%";
					break;
				default:
					haxe_Log.trace("ERROR: unknown matchTypeOption value:" + matchTypeOption.val(),{ fileName : "FormData.hx", lineNumber : 168, className : "view.FormData", methodName : "filter"});
					tmp = "ERROR|unknown matchTypeOption value:" + matchTypeOption.val();
				}
				ret.push(tmp);
				continue;
			}
			if(tDn.indexOf("range_from_") == 0) {
				...
				haxe_Log.trace(name + ":" + jForm.find("[name=\"range_from_" + name + "\"]").val(),{ fileName : "FormData.hx", lineNumber : 180, className : "view.FormData", methodName : "filter"});
		...
		if(item[0].value != null && item[0].value != "" || item[0].name.indexOf("range_from_") == 0) {
			...
			if(matchTypeOption.length == 1) {
				...
				case "start":
					...
					break;
				default:
					haxe_Log.trace("ERROR: unknown matchTypeOption value:" + matchTypeOption.val(),{ fileName : "FormData.hx", lineNumber : 283, className : "view.FormData", methodName : "where"});
					tmp5 = "ERROR|unknown matchTypeOption value:" + matchTypeOption.val();
				}
				ret1.push(tmp5);
				continue;
			}
			if(item[0].name.indexOf("range_from_") == 0) {
				...
				haxe_Log.trace(name + ":" + jForm.find("[name=\"range_from_" + name + "\"]").val(),{ fileName : "FormData.hx", lineNumber : 295, className : "view.FormData", methodName : "where"});
				var to = jForm.find("[name=\"range_to_" + name + "\"]").val();
				if(to.length > 0) {
					to = view_FormData.gDateTime2mysql(to + " 23:59:59");
				}
...
view_Mailing.prototype = $extend(View.prototype,{
	...
	,printNewMembers: function(mID) {
		...
		$.fileDownload(url,{ successCallback : function(url1) {
			haxe_Log.trace("OK: " + url1,{ fileName : "Mailing.hx", lineNumber : 38, className : "view.Mailing", methodName : "printNewMembers"});
			$("#" + mID + " #preparing-file-download").hide();
			$("#" + mID + " #success-download").show();
		}, failCallback : function(responseHtml,url2) {
			haxe_Log.trace("oops " + url2 + " " + responseHtml,{ fileName : "Mailing.hx", lineNumber : 44, className : "view.Mailing", methodName : "printNewMembers"});
			$("#" + mID + " #preparing-file-download").hide();
			$("#error-download").show();
		}});
		return;
	...
	,printList: function(mID) {
		...
		haxe_Log.trace(url,{ fileName : "Mailing.hx", lineNumber : 67, className : "view.Mailing", methodName : "printList"});
		$("#" + mID + " #preparing-file-download").show();
		$("#" + mID + " #success-download").hide();
		$.fileDownload(url,{ successCallback : function(url1) {
			haxe_Log.trace("OK: " + url1,{ fileName : "Mailing.hx", lineNumber : 73, className : "view.Mailing", methodName : "printList"});
			$("#" + mID + " #preparing-file-download").hide();
			$("#" + mID + " #success-download").show();
		}, failCallback : function(responseHtml,url2) {
			haxe_Log.trace("oops " + url2 + " " + responseHtml,{ fileName : "Mailing.hx", lineNumber : 79, className : "view.Mailing", methodName : "printList"});
			$("#" + mID + " #preparing-file-download").hide();
			$("#error-download").show();
		}});
		return;
	...
	,printNewInfos: function(mID) {
		...
		haxe_Log.trace(url,{ fileName : "Mailing.hx", lineNumber : 101, className : "view.Mailing", methodName : "printNewInfos"});
		$("#" + mID + " #preparing-file-download").show();
		$("#" + mID + " #success-download").hide();
		$.fileDownload(url,{ successCallback : function(url1) {
			haxe_Log.trace("OK: " + url1,{ fileName : "Mailing.hx", lineNumber : 108, className : "view.Mailing", methodName : "printNewInfos"});
			$("#" + mID + " #preparing-file-download").hide();
			$("#" + mID + " #success-download").show();
		}, failCallback : function(responseHtml,url2) {
			haxe_Log.trace("oops " + url2 + " " + responseHtml,{ fileName : "Mailing.hx", lineNumber : 115, className : "view.Mailing", methodName : "printNewInfos"});
			$("#" + mID + " #preparing-file-download").hide();
			$("#error-download").show();
		}});
	}
...
view_QC.prototype = $extend(View.prototype,{
	...
	,select: function(evt) {
		...
		if(App.ist.ctrlPressed) {
			haxe_Log.trace("ctrlPressed",{ fileName : "QC.hx", lineNumber : 65, className : "view.QC", methodName : "select"});
		}
		var jTarget = $(evt.target).parent();
		if(jTarget.hasClass("selected")) {
			this.wait(false);
...
var view_TabBox = function(data) {
	...
	if(data != null) {
		...
		this.tabObj = js_JqueryUI.tabs(this.root,{ active : 0, activate : function(event,ui) {
			haxe_Log.trace($(ui.newPanel),{ fileName : "TabBox.hx", lineNumber : 91, className : "view.TabBox", methodName : "new"});
			...
			try {
				...
				haxe_Log.trace(App.ist.globals.templates,{ fileName : "TabBox.hx", lineNumber : 98, className : "view.TabBox", methodName : "new"});
				haxe_Log.trace("selector:" + selector,{ fileName : "TabBox.hx", lineNumber : 99, className : "view.TabBox", methodName : "new"});
				template = Reflect.field(App.ist.globals.templates,$("#" + selector).attr("href"));
				if(!(template != null && template != 0 && template != "")) {
					haxe_Log.trace("loading templates/" + $("#" + selector).attr("href") + ".html...",{ fileName : "TabBox.hx", lineNumber : 104, className : "view.TabBox", methodName : "new"});
					$.get("templates/" + $("#" + selector).attr("href") + ".html",function(data1,textStatus,xhr) {
						haxe_Log.trace("" + textStatus + ":" + xhr.responseURL + xhr.getAllResponseHeaders(),{ fileName : "TabBox.hx", lineNumber : 106, className : "view.TabBox", methodName : "new"});
						if(data1.length > 0) {
							haxe_Log.trace(data1.substr(0,100),{ fileName : "TabBox.hx", lineNumber : 108, className : "view.TabBox", methodName : "new"});
						}
						if(textStatus == "success") {
							...
							haxe_Log.trace(window.lastView,{ fileName : "TabBox.hx", lineNumber : 115, className : "view.TabBox", methodName : "new"});
							if(window.lastView == null) {
								return;
							}
							_gthis.tabBoxData.tabs[_gthis.tabsInstance.options.active].views.push(window.lastView);
							haxe_Log.trace(Std.string(_gthis.tabsInstance.options.active) + ":" + _gthis.tabBoxData.tabs[_gthis.tabsInstance.options.active].views.length,{ fileName : "TabBox.hx", lineNumber : 120, className : "view.TabBox", methodName : "new"});
							...
							haxe_Log.trace("adding:" + _gthis.tabBoxData.tabs[_gthis.tabsInstance.options.active].id + " to:" + _gthis.id + " @:" + Std.string(_gthis.tabsInstance.options.active),{ fileName : "TabBox.hx", lineNumber : 129, className : "view.TabBox", methodName : "new"});
							_gthis.addView(v);
				...
				if (ex instanceof js__$Boot_HaxeError) ex = ex.val;
				haxe_Log.trace(ex,{ fileName : "TabBox.hx", lineNumber : 141, className : "view.TabBox", methodName : "new"});
			}
			haxe_Log.trace("activate:" + Std.string(ui.newPanel.selector) + ":" + Std.string(ui.newTab.context) + ":" + Std.string(_gthis.tabsInstance.options.active) + ":" + _gthis.active + " template:" + template,{ fileName : "TabBox.hx", lineNumber : 142, className : "view.TabBox", methodName : "new"});
			...
			haxe_Log.trace("ready2load content4tabs:" + _gthis.tabBoxData.tabs.length,{ fileName : "TabBox.hx", lineNumber : 150, className : "view.TabBox", methodName : "new"});
			var tmp = $("#" + _gthis.id);
			_gthis.tabsInstance = js_JqueryUI.tabs(tmp,"instance");
			...
			while(_g2 < _g11.length) {
				...
				while(_g21 < _g3.length) {
					...
					haxe_Log.trace("adding:" + t.id + " to:" + _gthis.id + " @:" + tabIndex,{ fileName : "TabBox.hx", lineNumber : 174, className : "view.TabBox", methodName : "new"});
					_gthis.addView(v1);
					if(tabIndex != _gthis.active) {
			...
			haxe_Log.trace("beforeLoad " + ui2.ajaxSettings.url,{ fileName : "TabBox.hx", lineNumber : 185, className : "view.TabBox", methodName : "new"});
			return false;
		}, heightStyle : this.tabBoxData.heightStyle == null ? "auto" : this.tabBoxData.heightStyle});
		haxe_Log.trace(this.tabsInstance.option("active"),{ fileName : "TabBox.hx", lineNumber : 192, className : "view.TabBox", methodName : "new"});
		haxe_Log.trace(this.dbLoader.length + ":" + this.active,{ fileName : "TabBox.hx", lineNumber : 193, className : "view.TabBox", methodName : "new"});
	}
	haxe_Log.trace(window.location.pathname + " != " + App.basePath,{ fileName : "TabBox.hx", lineNumber : 196, className : "view.TabBox", methodName : "new"});
...
view_TabBox.prototype = $extend(View.prototype,{
	...
	,tabLabel: null
	,go: function(url) {
		haxe_Log.trace(url + ":" + this.tabLinks.join(","),{ fileName : "TabBox.hx", lineNumber : 210, className : "view.TabBox", methodName : "go"});
		haxe_Log.trace(Std.string(this.tabsInstance.options.active) + " : " + this.tabLinks.indexOf(url),{ fileName : "TabBox.hx", lineNumber : 211, className : "view.TabBox", methodName : "go"});
		if(url.indexOf("?") > -1) {
		...
		if(typeof(url) != "string") {
			me_cunity_debug_Out.dumpStack(haxe_CallStack.callStack(),{ fileName : "TabBox.hx", lineNumber : 233, className : "view.TabBox", methodName : "go"});
			return;
		}
		...
		if(this.tabsInstance.options.active == this.tabLinks.indexOf(p[1])) {
			haxe_Log.trace(Std.string(this.tabsInstance.options.active) + " == " + this.tabLinks.indexOf(p[1]),{ fileName : "TabBox.hx", lineNumber : 244, className : "view.TabBox", methodName : "go"});
			return;
		}
		if(this.tabLinks[this.tabsInstance.options.active] != p[1]) {
			haxe_Log.trace(this.id + " root:" + this.root.attr("id"),{ fileName : "TabBox.hx", lineNumber : 249, className : "view.TabBox", methodName : "go"});
			if(this.tabObj != null) {
