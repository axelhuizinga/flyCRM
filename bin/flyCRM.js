...
App.init = $hx_exports["initApp"] = function(config) {
	...
	App.ist.globals = {};//optionsMap:new haxe_ds_StringMap() 
	return App.ist;
};
...
App.prototype = {
	...
	,logTrace: function(logMsg,file) {
		if(file == null) {
			file = "/var/www/crm/dev.log";
		}
		var p = { logFile : "/var/www/crm/app.log", user : App.user, log : logMsg};
	...
	,initUI: function(viewConfigs) {
		//dumpObject(this.globals.optionsMap,1);
		var _gthis = this;
		var _g = 0;
...
window.dumpObjectRSafe = me_cunity_debug_Out.dumpObjectRSafe = function(root,recursive,i) {
	if(recursive == null) {
		recursive = false;
	}
	var oCopy = { };
...
window.dumpObjectTree = me_cunity_debug_Out.dumpObjectTree = $hx_exports["me"]["cunity"]["debug"]["Out"]["dumpObjectTree"] = function(root,recursive,i) {
	if(recursive == null) {
		recursive = false;
	}
...
window.dumpObject = me_cunity_debug_Out.dumpObject = function(ob,i) {
	var o = ob;
...
me_cunity_js_data_IBAN.checkIBAN = function(iban) {
	console.log(iban + ':' + checkIBAN(iban));
...
view_Editor.prototype = $extend(View.prototype,{
 ...
 haxe_Log.trace("checkIban:" + me_cunity_js_data_IBAN.checkIBAN(iban),{ fileName : "Editor.hx", lineNumber : 59, className : "view.Editor", methodName : "checkIban"});
	...
	,checkAccountAndBLZ: function(ok2submit) {
		...
		me_cunity_js_data_IBAN.buildIBAN(account,blz,function(success) {
			if(me_cunity_js_data_IBAN.checkIBAN(success.iban)) {
				...
				haxe_Log.trace(success.iban + ":" + Std.string($("#" + _gthis.ibanSelector).val()),{ fileName : "Editor.hx", lineNumber : 78, className : "view.Editor", methodName : "checkAccountAndBLZ"});
				ok2submit(true);
			}
		},function(error) {
			haxe_Log.trace(error.message,{ fileName : "Editor.hx", lineNumber : 84, className : "view.Editor", methodName : "checkAccountAndBLZ"});
			ok2submit(false);
		});
	}
	,editCheck: function(dataRow) {
		...
		haxe_Log.trace(p,{ fileName : "Editor.hx", lineNumber : 103, className : "view.Editor", methodName : "editCheck"});
		haxe_Log.trace(this.leadID,{ fileName : "Editor.hx", lineNumber : 104, className : "view.Editor", methodName : "editCheck"});
		p.action = "edit";
	...
	,compareEdit: function(data) {
		...
		while(_g < _g1.length) {
			...
			if(displayFormat != null) {
				if(displayFormat.indexOf("%") > -1) {
					...
					if(displayFormat.indexOf("_") == 0) {
						haxe_Log.trace("input[name=\"_" + f + "\"]",{ fileName : "Editor.hx", lineNumber : 136, className : "view.Editor", methodName : "compareEdit"});
					...
					haxe_Log.trace(Std.string(dbData) + ":" + displayFormat + ":" + Std.string(val),{ fileName : "Editor.hx", lineNumber : 141, className : "view.Editor", methodName : "compareEdit"});
				}
			} else {
			...
			if(!cOK) {
				haxe_Log.trace("" + Std.string(dbData) + "< oops - " + f + ": >" + shouldDVal + "< not = >" + Std.string(this.overlay.find("[name=\"" + f + "\"]").val()) + "<",{ fileName : "Editor.hx", lineNumber : 169, className : "view.Editor", methodName : "compareEdit"});
				errors_b += Std.string("oops - " + f + ": " + shouldDVal + " not = " + Std.string(this.overlay.find("[name=\"" + f + "\"]").val()) + "<-\r\n");
			}
		}
		if(errors_b.length > 0) {
			haxe_Log.trace("edit check failed :(" + errors_b + "\r\n",{ fileName : "Editor.hx", lineNumber : 176, className : "view.Editor", methodName : "compareEdit"});
			...
			$.post("/flyCRM/editorLog.php",content,function(d1,s,_) {
				haxe_Log.trace(d1,{ fileName : "Editor.hx", lineNumber : 186, className : "view.Editor", methodName : "compareEdit"});
				haxe_Log.trace(s,{ fileName : "Editor.hx", lineNumber : 186, className : "view.Editor", methodName : "compareEdit"});
			}).fail(function() {
				haxe_Log.trace("error",{ fileName : "Editor.hx", lineNumber : 187, className : "view.Editor", methodName : "compareEdit"});
			});
		}
		this.close();
		if(this.lastFindParam != null) {
			...
			haxe_Log.trace(p,{ fileName : "Editor.hx", lineNumber : 199, className : "view.Editor", methodName : "compareEdit"});
	...
	,edit: function(dataRow) {
		haxe_Log.trace(dataRow,{ fileName : "Editor.hx", lineNumber : 212, className : "view.Editor", methodName : "edit"});
		...
		haxe_Log.trace(this.leadID,{ fileName : "Editor.hx", lineNumber : 230, className : "view.Editor", methodName : "edit"});
		p.action = "edit";
		p.fields = this.vData.fields != null ? this.vData.fields : this.parentView.vData.fields;
		haxe_Log.trace(p,{ fileName : "Editor.hx", lineNumber : 235, className : "view.Editor", methodName : "edit"});
		this.cMenu.set_active(this.cMenu.getIndexOf(p.action));
		haxe_Log.trace(Std.string(p.action) + ":" + this.cMenu.get_active(),{ fileName : "Editor.hx", lineNumber : 238, className : "view.Editor", methodName : "edit"});
		this.cMenu.root.data("disabled",1);
		this.loadData("server.php",p,$bind(this,this.update));
	}
	,close: function() {
		var _gthis = this;
		haxe_Log.trace("going to close:" + $("#overlay").length,{ fileName : "Editor.hx", lineNumber : 245, className : "view.Editor", methodName : "close"});
		...
		case "qcok":case "save":
			if(!this.checkIban()) {
				this.checkAccountAndBLZ(function(ok) {
					haxe_Log.trace(ok,{ fileName : "Editor.hx", lineNumber : 268, className : "view.Editor", methodName : "contextAction"});
					if(ok) {
			...
			break;
		default:
			haxe_Log.trace(action,{ fileName : "Editor.hx", lineNumber : 307, className : "view.Editor", methodName : "contextAction"});
		}
	}
	,hangup: function(editor,onCompletion) {
		var _gthis = this;
		haxe_Log.trace("OK",{ fileName : "Editor.hx", lineNumber : 313, className : "view.Editor", methodName : "hangup"});
		var fData = view_FormData.save($("#" + this.parentView.id + "-edit-form"));
		haxe_Log.trace(fData,{ fileName : "Editor.hx", lineNumber : 316, className : "view.Editor", methodName : "hangup"});
		...
		while(_g < fData.length) {
			var fd1 = fData[_g];
			++_g;
			p[fd1.name] = fd1.value;
		}
		haxe_Log.trace(p,{ fileName : "Editor.hx", lineNumber : 329, className : "view.Editor", methodName : "hangup"});
		this.parentView.loadData("server.php",p,function(data) {
			if(data.response == "OK") {
				haxe_Log.trace("OK => agent screen updated",{ fileName : "Editor.hx", lineNumber : 335, className : "view.Editor", methodName : "hangup"});
				var p1 = { className : "AgcApi", action : "external_hangup", lead_id : editor.leadID, agent_user : editor.agent};
				_gthis.parentView.loadData("server.php",p1,function(data1) {
					if(data1.response == "OK") {
						haxe_Log.trace("OK",{ fileName : "Editor.hx", lineNumber : 347, className : "view.Editor", methodName : "hangup"});
	...
	,ready4save: function() {
		...
		$.ajax({ type : "POST", url : "server.php", data : p, success : function(result) {
			haxe_Log.trace(result,{ fileName : "Editor.hx", lineNumber : 379, className : "view.Editor", methodName : "ready4save"});
			try {
				if(result.response.status != "INCALL") {
					haxe_Log.trace("OK - CALL ENDED",{ fileName : "Editor.hx", lineNumber : 385, className : "view.Editor", methodName : "ready4save"});
					amReady = true;
				}
			} catch( ex ) {
				if (ex instanceof js__$Boot_HaxeError) ex = ex.val;
				haxe_Log.trace(ex,{ fileName : "Editor.hx", lineNumber : 392, className : "view.Editor", methodName : "ready4save"});
			}
		}, dataType : "json", async : false});
		haxe_Log.trace("returning " + (amReady == null ? "null" : "" + amReady),{ fileName : "Editor.hx", lineNumber : 399, className : "view.Editor", methodName : "ready4save"});
		return amReady;
	}
	,save: function(status,maxSaveLoop) {
		...
		var _gthis = this;
		haxe_Log.trace(this.parentView.interactionState,{ fileName : "Editor.hx", lineNumber : 405, className : "view.Editor", methodName : "save"});
		if(this.parentView.interactionState == "call") {
			if(maxSaveLoop < 1 || !this.ready4save()) {
				haxe_Log.trace("have to wait..." + maxSaveLoop,{ fileName : "Editor.hx", lineNumber : 413, className : "view.Editor", methodName : "save"});
				haxe_Timer.delay(function() {
		...
		haxe_Log.trace(p,{ fileName : "Editor.hx", lineNumber : 420, className : "view.Editor", methodName : "save"});
		...
		haxe_Log.trace(status,{ fileName : "Editor.hx", lineNumber : 426, className : "view.Editor", methodName : "save"});
		switch(status) {
		case "errsal":
			p.push({ name : "status", value : "ERRSALE"});
			break;
		case "call":case "qcbad":case "qcok":
			var tmp1 = status == "call" ? "QCOPEN" : status.toUpperCase();
			p.push({ name : "status", value : tmp1});
			break;
		}
		if(this.parentView.vData.hidden != null) {
			var hKeys = this.parentView.vData.hidden.split(",");
			...
			while(_g < hKeys.length) {
				...
				++_g;
				var tmp2;
				if(this.eData.data(k[0]) != null) {
					var tmp3 = (function(k1) {
						return function(jD) {
							return jD.name != k1[0];
						};
					})(k);
					tmp2 = Lambda.foreach(p,tmp3);
				} else {
					tmp2 = false;
				}
				if(tmp2) {
					var k2 = k[0];
					var tmp4 = this.eData.data(k[0]);
					p.push({ name : k2, value : tmp4});
				}
			}
		}
		haxe_Timer.delay(function() {
			_gthis.parentView.loadData("server.php",p,function(data) {
				haxe_Log.trace(Std.string(data) + ": " + (data ? "Y" : "N"),{ fileName : "Editor.hx", lineNumber : 446, className : "view.Editor", methodName : "save"});
				if(data) {
	...
	,update: function(data) {
		...
		haxe_Log.trace(data,{ fileName : "Editor.hx", lineNumber : 460, className : "view.Editor", methodName : "update"});
		var dataOptions = { };
		...
		var dRows = data.rows;
		haxe_Log.trace(dRows.length,{ fileName : "Editor.hx", lineNumber : 476, className : "view.Editor", methodName : "update"});
		...
		this.overlay = this.templ.tmpl(data).appendTo("#" + this.parentView.id).css({ marginTop : Std.string(mSpace.top + oMargin) + "px", marginLeft : (oMargin == null ? "null" : "" + oMargin) + "px", height : Std.string(mSpace.height - 2 * oMargin - parseFloat($("#overlay").css("padding-top")) - parseFloat($("#overlay").css("padding-bottom"))) + "px", width : Std.string($("#" + Std.string(this.parentView.vData.id) + "-menu").offset().left - 35) + "px"}).animate({ opacity : 1},{ done : function(el) {
			haxe_Log.trace($("#" + _gthis.parentView.id).find("input[name=\"period\"]").length,{ fileName : "Editor.hx", lineNumber : 509, className : "view.Editor", methodName : "update"});
			var unchecked = true;
			$("#" + _gthis.parentView.id).find("input[name=\"period\"]").each(function(i,n) {
				haxe_Log.trace($(n).prop("checked"),{ fileName : "Editor.hx", lineNumber : 512, className : "view.Editor", methodName : "update"});
				if($(n).prop("checked")) {
					unchecked = false;
				}
			});
		...
		haxe_Log.trace(mSpace.height + ":" + 2 * oMargin + ":" + parseFloat($("#overlay").css("padding-top")) + ":" + parseFloat($("#overlay").css("padding-bottom")),{ fileName : "Editor.hx", lineNumber : 524, className : "view.Editor", methodName : "update"});
		$("#" + this.parentView.id + " .scrollbox").height($("#" + this.parentView.id + " #overlay").height());
		haxe_Log.trace(this.id + ":" + this.parentView.id + ":" + $("#" + this.parentView.id + " .scrollbox").length + ":" + $("#" + this.parentView.id + " .scrollbox").height(),{ fileName : "Editor.hx", lineNumber : 526, className : "view.Editor", methodName : "update"});
	}
	,__class__: view_Editor
});
var view_ClientEditor = function(data) {
	view_Editor.call(this,data);
	dumpObjectRSafe(data,1);
	dumpObject({ClientEditor:'data=>instance'},1)
	dumpObjectRSafe(this,1);
	dumpObjectRSafe(this.vData,1);
...
view_ClientEditor.prototype = $extend(view_Editor.prototype,{
	...
	,loadBlock: function(name) {
		...
		var dRows = sData != null ? Reflect.field(this.editData,name).data : [];
		haxe_Log.trace(dRows,{ fileName : "ClientEditor.hx", lineNumber : 228, className : "view.ClientEditor", methodName : "loadBlock"});
		sData.table = name;
		...
		if(name == "pay_history") {
			sData = { rows : [], m_ID : this.editData.clients.data[0].client_id};
			//dumpObject(this.editData.konto_auszug);
			var kontoRows = Reflect.field(this.editData,"konto_auszug").data;
			var _g = 0;
			...
			sData.rows = dateSort("Termin",sData.rows).map(function(v){
				return{
					Termin:display(displayFormats['d'],v.Termin),
					Betrag:display(displayFormats['amount'],v.Betrag),
					info:v.info,
					extra:v.extra
				}
			});
	...
	,showScreen: function(name) {
		...
		if(name == "pay_history") {
			...
			//dumpObject(_this1,1);, width : Std.string($("#clients-menu").offset().left - 35) + "px"
			//dumpObject(sData,1);
			var value = $("#t-pay-history-editor").tmpl(sData).appendTo("#" + this.parentView.id).css({ marginTop : Std.string(mSpace.top + oMargin) + "px", marginLeft : (oMargin == null ? "null" : "" + oMargin) + "px", height : Std.string(mSpace.height - 2 * oMargin - parseFloat($("#overlay").css("padding-top")) - parseFloat($("#overlay").css("padding-bottom"))) + "px"}).animate({ opacity : 1});
			if(__map_reserved[name] != null) {
			...
			//dumpObject(sData,1);, width : Std.string($("#clients-menu").offset().left - 35) + "px"
			var value1 = $("#t-pay-editor").tmpl(sData).appendTo("#" + this.parentView.id).css({ marginTop : Std.string(mSpace.top + oMargin) + "px", marginLeft : (oMargin == null ? "null" : "" + oMargin) + "px", height : Std.string(mSpace.height - 2 * oMargin - parseFloat($("#overlay").css("padding-top")) - parseFloat($("#overlay").css("padding-bottom"))) + "px"}).animate({ opacity : 1});
			if(__map_reserved[name] != null) {
	...
	,update: function(data) {
		...
		//haxe_Log.trace(this.editData.clients,{ fileName : "ClientEditor.hx", lineNumber : 435, className : "view.ClientEditor", methodName : "update"});
		this.agent = data.agent;
		...
		this.cMenu.activePanel.find("form").append(recordings);
		var oMargin = 8;
		var mSpace = App.getMainSpace();//.h[0].agent
		//haxe_Log.trace(data.editData.pay_plan.data[0].agent,{ fileName : "ClientEditor.hx", lineNumber : 465, className : "view.ClientEditor", methodName : "update"});//data.userMap.a.find(
		haxe_Log.trace(data.userMap.arr.find(function(uM) {
			return uM.user == data.editData.pay_plan.data[0].agent;
		}),{ fileName : "ClientEditor.hx", lineNumber : 467, className : "view.ClientEditor", methodName : "update"});
		//dumpObject(data.editData.clients, 1);
		...
		$("#" + this.parentView.id + "-edit-form .datepicker").each(function(i,n) {
			...
			var dateString = _gthis.editData.clients.data[0][$(n).attr("name")];
...
var view_ContextMenu = function(data) {
	...
	//dumpObject(this.contextData.tableData);
	...
	//dumpObject(App.ist.globals.optionsMap,1);
	data.optionsMap = App.ist.globals.optionsMap;
	data.typeMap = App.ist.globals.typeMap;
	if(this.id == "qc-menu") {
...
view_ContextMenu.prototype = $extend(View.prototype,{
	...
	,hangup: function(editor,onCompletion) {
		...
		this.parentView.loadData("server.php",p,function(data) {
			if(data.response == "OK") {
				haxe_Log.trace("OK state CLEARED",{ fileName : "ContextMenu.hx", lineNumber : 223, className : "view.ContextMenu", methodName : "hangup"});
				var p1 = { className : "AgcApi", action : "external_hangup", lead_id : editor.leadID, agent_user : editor.agent};
				_gthis.parentView.loadData("server.php",p1,function(data1) {
					if(data1.response == "OK") {
						haxe_Log.trace("OK",{ fileName : "ContextMenu.hx", lineNumber : 235, className : "view.ContextMenu", methodName : "hangup"});
	...
	,findPage: function(page,limit) {
		...
		haxe_Log.trace(this.action + ":" + this.get_active(),{ fileName : "ContextMenu.hx", lineNumber : 280, className : "view.ContextMenu", methodName : "findPage"});
		var findFields = this.vData.items[this.get_active()].fields;
		haxe_Log.trace(findFields,{ fileName : "ContextMenu.hx", lineNumber : 282, className : "view.ContextMenu", methodName : "findPage"});
		if(findFields != null && findFields.length > 0) {
			...
			while(tables.hasNext()) {
				...
				haxe_Log.trace(table,{ fileName : "ContextMenu.hx", lineNumber : 291, className : "view.ContextMenu", methodName : "findPage"});
			}
			var form = $("#" + this.parentView.id + "-menu .ui-accordion-content-active form");
			var where = view_FormData.where(form,findFields);
			haxe_Log.trace(where,{ fileName : "ContextMenu.hx", lineNumber : 296, className : "view.ContextMenu", methodName : "findPage"});
			...
			haxe_Log.trace(wM,{ fileName : "ContextMenu.hx", lineNumber : 305, className : "view.ContextMenu", methodName : "findPage"});
	...
	,run: function(evt) {
		...
		haxe_Log.trace(this.action + ":" + this.get_active(),{ fileName : "ContextMenu.hx", lineNumber : 319, className : "view.ContextMenu", methodName : "run"});
		var contextAction = jNode.data("contextaction");
		haxe_Log.trace(this.action + ":" + contextAction,{ fileName : "ContextMenu.hx", lineNumber : 322, className : "view.ContextMenu", methodName : "run"});
		var _g = this.action;
		switch(_g) {
		case "edit":
			var _this = this.parentView.views;
		...
		case "find":
			...
			if(fields != null && fields.length > 0) {
				...
				while(tables.hasNext()) {
					var table = tables.next();
					tableNames.push(table);
					haxe_Log.trace(table,{ fileName : "ContextMenu.hx", lineNumber : 336, className : "view.ContextMenu", methodName : "run"});
				}
				var where = view_FormData.where(jNode.closest("form"),fields);
				haxe_Log.trace(where,{ fileName : "ContextMenu.hx", lineNumber : 341, className : "view.ContextMenu", methodName : "run"});
				var wM = new haxe_ds_StringMap();
		...
		case "mailings":
			...
			haxe_Log.trace(contextAction,{ fileName : "ContextMenu.hx", lineNumber : 356, className : "view.ContextMenu", methodName : "run"});
			switch(contextAction) {
			case "printList":
			...
			case "printNewMembers":
				...
				break;
			default:
				haxe_Log.trace(contextAction,{ fileName : "ContextMenu.hx", lineNumber : 366, className : "view.ContextMenu", methodName : "run"});
			}
			break;
		default:
			haxe_Log.trace(this.action + ":" + contextAction,{ fileName : "ContextMenu.hx", lineNumber : 369, className : "view.ContextMenu", methodName : "run"});
		}
	}
	,setCallStatus: function(editor,onCompletion) {
		var _gthis = this;
		haxe_Log.trace(editor.action + ":" + Std.string(onCompletion),{ fileName : "ContextMenu.hx", lineNumber : 375, className : "view.ContextMenu", methodName : "setCallStatus"});
		...
		this.parentView.loadData("server.php",p1,function(data) {
			haxe_Log.trace(data,{ fileName : "ContextMenu.hx", lineNumber : 389, className : "view.ContextMenu", methodName : "setCallStatus"});
			if(data.response == "OK") {
	...
	,initState: function() {
		...
		haxe_Log.trace(this.id + ":" + this.root.find("tr[data-table]").length,{ fileName : "ContextMenu.hx", lineNumber : 407, className : "view.ContextMenu", methodName : "initState"});
		this.layout();
		...
		while(tables.hasNext()) {
			...
			haxe_Log.trace(table1[0],{ fileName : "ContextMenu.hx", lineNumber : 423, className : "view.ContextMenu", methodName : "initState"});
		...
		haxe_Log.trace(this.contextData.tableData.toString(),{ fileName : "ContextMenu.hx", lineNumber : 432, className : "view.ContextMenu", methodName : "initState"});
	}
