...
class model_AgcApi extends Model {
	...
	public function external_dial($param) {
		$url = "" . _hx_string_or_null(S::$request_scheme) . "://" . _hx_string_or_null(S::$host) . "/agc/api.php?source=flyCRM&user=" . _hx_string_or_null($this->vicidialUser) . "&pass=" . _hx_string_or_null($this->vicidialPass) . "&function=external_dial&search=NO&preview=NO&focus=NO&lead_id=";
	...
	public function external_hangup($param) {
		if($param->get("pause") === "Y") {
			$tmp = "" . _hx_string_or_null(S::$request_scheme) . "://" . _hx_string_or_null(S::$host) . "/agc/api.php?source=flyCRM&user=" . _hx_string_or_null($this->vicidialUser) . "&pass=" . _hx_string_or_null($this->vicidialPass) . "&function=external_pause&value=PAUSE&agent_user=";
			haxe_Http::requestUrl(_hx_string_or_null($tmp) . _hx_string_or_null($param->get("agent_user")));
		}
		$url = "" . _hx_string_or_null(S::$request_scheme) . "://" . _hx_string_or_null(S::$host) . "/agc/api.php?source=flyCRM&user=" . _hx_string_or_null($this->vicidialUser) . "&pass=" . _hx_string_or_null($this->vicidialPass) . "&function=external_hangup&value=1&agent_user=";
	...
	public function external_status($param) {
		...
		$url = "" . _hx_string_or_null(S::$request_scheme) . "://" . _hx_string_or_null(S::$host) . "/agc/api.php?source=flyCRM&user=" . _hx_string_or_null($this->vicidialUser) . "&pass=" . _hx_string_or_null($this->vicidialPass) . "&function=external_status&value=" . _hx_string_or_null($status) . "&agent_user=";
		$url1 = _hx_string_or_null($url) . _hx_string_or_null($param->get("agent_user"));
