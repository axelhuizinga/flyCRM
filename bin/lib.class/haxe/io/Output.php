...
class Output {
	...
	public function writeBytes ($s, $pos, $len) {
		...
		while ($k > 0) {
			#C:\HaxeToolkit\haxe\std/haxe/io/Output.hx:68: characters 5-26
	...
	public function writeFullBytes ($s, $pos, $len) {
		#C:\HaxeToolkit\haxe\std/haxe/io/Output.hx:123: lines 123-127
		while ($len > 0) {
			#C:\HaxeToolkit\haxe\std/haxe/io/Output.hx:124: characters 4-34
			$k = $this->writeBytes($s, $pos, $len);
			#C:\HaxeToolkit\haxe\std/haxe/io/Output.hx:125: characters 4-12
			$pos = $pos + $k;
			#C:\HaxeToolkit\haxe\std/haxe/io/Output.hx:126: characters 4-12
			$len = $len - $k;
		}
	}
	...
	public function writeString ($s) {
		#C:\HaxeToolkit\haxe\std/haxe/io/Output.hx:282: characters 11-28
		$s1 = strlen($s);
		#C:\HaxeToolkit\haxe\std/haxe/io/Output.hx:282: characters 3-29
		$b = new Bytes($s1, new Container($s));
		#C:\HaxeToolkit\haxe\std/haxe/io/Output.hx:284: characters 3-31
