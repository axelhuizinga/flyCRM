...
EOS
        ...
        {
                #        TODO: wantInfo Flag gesetzt hier prï¿½fen
...
EOS
					 trace($sql);
                                ...
                                case 'PRINTNEW' {
		  #ANSCHREIBEN NEUBEITRAG IF START WITHIN NEXT 45 DAYS
					 $sql = <<EOS;
		  SELECT IF(anrede='Herr','Herrn',anrede) AS anrede, IF(title!='',CONCAT(title,' '),''), first_name, last_name, address1, address2, '' AS email, co_field AS co_feld, postal_code, city,
		  start_monat,
		  (CASE WHEN buchungs_zeitpunkt = '15' THEN 'Mitte' ELSE 'Anfang' END)AS buchungs_zeitpunkt,
...
sub sendMail
{
        ...
        <p>wir bedanken uns fï¿½r Ihr Interesse und senden Ihnen im Anhang die gewï¿½nschten Informationen zu unserem
        Engagement in der Berliner Kinderhilfe Schutzengel. </p>
        <p>Herzliche Grï¿½ï¿½e,<br>
        Jacob Kalus
        </p>
        ...
        <div class=""><b style="font-size: 11px; text-align: -webkit-auto;" class="">-Auï¿½enstelle Fï¿½rderung-</b></div>
...
Johannes Kinder- und Jugendfï¿½rderung Deutschland
gemeinnï¿½tzige Gesellschaft mbH</b>
<div style="font-size: 11px;" face="Helvetica-Light">
Geschï¿½ftsfï¿½hrer: Jï¿½rgen Schnelle
Amtsgericht Berlin HRB 154526 B
StNr. zur Feststellung der Gemeinnï¿½tzigkeit: 27/613/02936
</div>
</pre>
</div>
</body>
