...
class S {
	...
	static function main() {
		...
		haxe_Log::trace($params, _hx_anonymous(array("fileName" => "S.hx", "lineNumber" => 48, "className" => "S", "methodName" => "main")));
		...
		haxe_Log::trace($action, _hx_anonymous(array("fileName" => "S.hx", "lineNumber" => 59, "className" => "S", "methodName" => "main")));
