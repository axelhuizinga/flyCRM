...
class me_cunity_debug_Out {
	...
	static function _trace($v, $i = null) {
		...
		if(me_cunity_debug_Out::$once) {
			...
			me_cunity_debug_Out::_trace("i:" . Std::string(Type::typeof($i)), _hx_anonymous(array("fileName" => "Out.hx", "lineNumber" => 128, "className" => "me.cunity.debug.Out", "methodName" => "_trace")));
			me_cunity_debug_Out::dumpObject($i, _hx_anonymous(array("fileName" => "Out.hx", "lineNumber" => 129, "className" => "me.cunity.debug.Out", "methodName" => "_trace")));
		}
	}
	...
	static function dumpVar($v, $i = null) {
			...
			$ret =  ob_get_clean();
		;
		me_cunity_debug_Out::_trace($ret, _hx_anonymous(array("fileName" => "Out.hx", "lineNumber" => 305, "className" => "me.cunity.debug.Out", "methodName" => "dumpVar")));
	}
...
function me_cunity_debug_Out_0(&$http, &$i, &$msg, &$v, $data) {
	{
		if($data !== "OK") {
			haxe_Log::trace($data, _hx_anonymous(array("fileName" => "Out.hx", "lineNumber" => 190, "className" => "me.cunity.debug.Out", "methodName" => "log2")));
		}
	}
}
