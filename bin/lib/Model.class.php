...
class Model {
	public function __construct($param = null) {
		...
		if($tmp) {
<<<<<<< HEAD
			haxe_Log::trace("firstLoad", _hx_anonymous(array("fileName" => "Model.hx", "lineNumber" => 490, "className" => "Model", "methodName" => "new")));
=======
			haxe_Log::trace("firstLoad", _hx_anonymous(array("fileName" => "Model.hx", "lineNumber" => 488, "className" => "Model", "methodName" => "new")));
>>>>>>> a32fff50bcc6512f1e0fbc14f62d7da0632f1c7d
...
=======
		$joinCond1 = null;
		if($v2 !== null) {
			$joinCond1 = !_hx_equal($v2, 0);
>>>>>>> a32fff50bcc6512f1e0fbc14f62d7da0632f1c7d
		} else {
			$joinCond1 = false;
		}
		if($joinCond1) {
			$joinCond = !_hx_equal($v2, "");
		} else {
			$joinCond = false;
		}
		if($joinCond) {
...
=======
		$joinTable1 = null;
		if($v3 !== null) {
			$joinTable1 = !_hx_equal($v3, 0);
>>>>>>> a32fff50bcc6512f1e0fbc14f62d7da0632f1c7d
		} else {
			$joinTable1 = false;
		}
		if($joinTable1) {
			$joinTable = !_hx_equal($v3, "");
		} else {
			$joinTable = false;
		}
		if($joinTable) {
...
>>>>>>> a32fff50bcc6512f1e0fbc14f62d7da0632f1c7d
		...
		}
		{
			...
			while($_g < $sF->length) {
				...
				if(Lambda::has($qKeys, $f)) {
					...
					$tmp = _hx_string_or_null($format[0]) . "(";
					$tmp1 = _hx_string_or_null($tmp) . _hx_string_or_null(S::$my->real_escape_string($f)) . ", \"";
					$fieldsWithFormat->push(_hx_string_or_null($tmp1) . _hx_string_or_null($format[1]) . "\") AS `" . _hx_string_or_null($f) . "`");
					unset($tmp1,$tmp,$format);
				} else {
	...
	public function find($param) {
		...
		call_user_func_array($tmp, array(_hx_string_or_null($tmp1) . _hx_string_or_null($tmp2), _hx_anonymous(array("fileName" => "Model.hx", "lineNumber" => 269, "className" => "Model", "methodName" => "find"))));
		$tmp3 = null;
		if($param->exists("page")) {
	...
	public function execute($sql, $phValues = null) {
		haxe_Log::trace($sql, _hx_anonymous(array("fileName" => "Model.hx", "lineNumber" => 281, "className" => "Model", "methodName" => "execute")));
		$stmt = S::$my->stmt_init();
		$success = $stmt->prepare($sql);
		haxe_Log::trace($success, _hx_anonymous(array("fileName" => "Model.hx", "lineNumber" => 285, "className" => "Model", "methodName" => "execute")));
		if(!$success) {
			haxe_Log::trace($stmt->error, _hx_anonymous(array("fileName" => "Model.hx", "lineNumber" => 288, "className" => "Model", "methodName" => "execute")));
			return null;
		}
		$bindTypes = "";
		$values2bind = null;
...
>>>>>>> a32fff50bcc6512f1e0fbc14f62d7da0632f1c7d
		...
		call_user_func_array($tmp, array($tmp1, _hx_anonymous(array("fileName" => "Model.hx", "lineNumber" => 305, "className" => "Model", "methodName" => "execute"))));
		if($phValues->length > 0) {
			...
			call_user_func_array($tmp2, array($tmp3, _hx_anonymous(array("fileName" => "Model.hx", "lineNumber" => 309, "className" => "Model", "methodName" => "execute"))));
			if($success) {
				$data = null;
				$success = $stmt->execute();
				if(!$success) {
					haxe_Log::trace($stmt->error, _hx_anonymous(array("fileName" => "Model.hx", "lineNumber" => 317, "className" => "Model", "methodName" => "execute")));
					return null;
				}
...
=======
					$this->num_rows = _hx_deref((_hx_cast($result, _hx_qtype("me.cunity.php.db.MySQLi_Result"))))->num_rows;
					$data = _hx_deref((_hx_cast($result, _hx_qtype("me.cunity.php.db.MySQLi_Result"))))->fetch_all(1);
>>>>>>> a32fff50bcc6512f1e0fbc14f62d7da0632f1c7d
				}
				return $data;
			}
			...
			$success = $stmt->execute();
			if(!$success) {
				haxe_Log::trace($stmt->error, _hx_anonymous(array("fileName" => "Model.hx", "lineNumber" => 335, "className" => "Model", "methodName" => "execute")));
...
=======
				$res = _hx_cast($result1, _hx_qtype("me.cunity.php.db.MySQLi_Result"));
>>>>>>> a32fff50bcc6512f1e0fbc14f62d7da0632f1c7d
	...
	public function query($sql) {
		haxe_Log::trace($sql, _hx_anonymous(array("fileName" => "Model.hx", "lineNumber" => 353, "className" => "Model", "methodName" => "query")));
		...
		if($tmp) {
			...
			haxe_Log::trace($res, _hx_anonymous(array("fileName" => "Model.hx", "lineNumber" => 360, "className" => "Model", "methodName" => "query")));
...
<<<<<<< HEAD
			...
			haxe_Log::trace($tmp1, _hx_anonymous(array("fileName" => "Model.hx", "lineNumber" => 366, "className" => "Model", "methodName" => "query")));
		}
		if(S::$my->connect_error !== null) {
			haxe_Log::trace(S::$my->connect_error, _hx_anonymous(array("fileName" => "Model.hx", "lineNumber" => 368, "className" => "Model", "methodName" => "query")));
=======
			haxe_Log::trace($ok, _hx_anonymous(array("fileName" => "Model.hx", "lineNumber" => 366, "className" => "Model", "methodName" => "query")));
>>>>>>> a32fff50bcc6512f1e0fbc14f62d7da0632f1c7d
		}
		return null;
	}
...
<<<<<<< HEAD
				call_user_func_array($tmp5, array($tmp8, _hx_anonymous(array("fileName" => "Model.hx", "lineNumber" => 393, "className" => "Model", "methodName" => "buildCond"))));
=======
				call_user_func_array($tmp5, array($tmp8, _hx_anonymous(array("fileName" => "Model.hx", "lineNumber" => 391, "className" => "Model", "methodName" => "buildCond"))));
>>>>>>> a32fff50bcc6512f1e0fbc14f62d7da0632f1c7d
				$tmp9 = null;
